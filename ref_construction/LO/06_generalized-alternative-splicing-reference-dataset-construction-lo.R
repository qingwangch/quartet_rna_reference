#' generalized-alternative-splicing-reference-dataset-construction-lo
#' Qingwang Chen
#' 2025-05-20
...
tools <- list(
  list(
    expr_file = "./bambu/quartet_s84/quartet_s84_events.psi",
    batch_for_construction = c("P_ONT_LG_B1", "P_ONT_LG_B2", "P_ONT_LN_B2", "M_PAB_LN_B1", "D_ONT_LG_B1", "D_ONT_LW_B1", "M_PAB_LG_B2"),
    output_prefix = "./ref_data_construction/bambu_s84",
    tool_name = "Bambu",
    das_file = "./bambu/quartet_s84/bambu_leg_DAS_s84.txt"
  ),
  list(
    expr_file = "./isoquant/quartet_s84/quartet_s84_events.psi",
    batch_for_construction = c("P_ONT_LG_B1", "P_ONT_LG_B2", "P_ONT_LN_B2", "M_PAB_LN_B1", "D_ONT_LG_B1", "D_ONT_LW_B1", "M_PAB_LG_B2"),
    output_prefix = "./ref_data_construction/isoquant_s84",
    tool_name = "IsoQuant",
    das_file = "./isoquant/quartet_s84/isoquant_leg_DAS_s84.txt"
  ),
  list(
    expr_file = "./stringtie2/LO-E-G/quartet_as_events_psi_combined_s84_lo_e_g.psi",
    batch_for_construction = c("P_ONT_LG_B1", "P_ONT_LG_B2", "P_ONT_LN_B2", "M_PAB_LN_B1", "D_ONT_LG_B1", "D_ONT_LW_B1", "M_PAB_LG_B2"),
    output_prefix = "./ref_data_construction/stringtie2_s84",
    tool_name = "StingTie2",
    das_file = "./stringtie2_lo/stlo_leg_DAS_s84.txt"
  ),
  list(
    expr_file = "./oarfish/quartet_s180/quartet_s180_events.psi",
    batch_for_construction = c("P_ONT_LG_B1", "P_ONT_LG_B2", "P_ONT_LN_B2", "M_PAB_LN_B1", "D_ONT_LG_B1", "D_ONT_LW_B1", "M_PAB_LG_B2"),
    output_prefix = "./ref_data_construction/oarfish_s84",
    tool_name = "Oarfish",
    das_file = "./oarfish/quartet_s84/oarfish_leg_DAS_s84.txt"
  )
)
